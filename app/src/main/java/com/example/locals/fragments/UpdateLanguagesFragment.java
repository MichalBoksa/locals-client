...
import com.example.locals.activities.GuideProfile;
...
public class UpdateLanguagesFragment extends DialogFragment {
    private RetrofitService retrofit;
    private Button updateBtn;
    private EditText languagesET;
    ...
    public View onCreateView(LayoutInflater inflater,@Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_update_languages,container,false);
        retrofit = new RetrofitService();
        retrofit.initializeRetrofit();
        accessCode = PKCE.getAccessToken(UpdateLanguagesFragment.this.getActivity());
        languagesET = view.findViewById(R.id.languagesUpdateFragmentET);
        languagesET.setText(languages);
        updateBtn = view.findViewById(R.id.editLanguagesFragmentBTN);
        cancelBtn = view.findViewById(R.id.closeLanguagesUpdate);
    ...
    private void RScall(String newLanguages) {
        ...
        addNewList.enqueue(new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                languagesET.setText(newLanguages);
            }

            @Override
            public void onFailure(Call<Void> call, Throwable t) {
                System.out.println(call);
                Toast.makeText(UpdateLanguagesFragment.this.getActivity(), "call error",Toast.LENGTH_LONG).show();
            }
        });
    }
}